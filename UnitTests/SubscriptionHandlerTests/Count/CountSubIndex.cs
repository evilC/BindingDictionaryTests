...
namespace UnitTests.SubscriptionHandlerTests.Count
{
    /// <summary>
    /// Given I have a SubscriptionHandler
    /// When I add or remove subscriptions
    /// Then the Count(BindingType, Index) method should return the correct number of subscribed SubIndexes of that Index
    /// </summary>
    [TestFixture]
    public class CountSubIndex
    {
        ...
        public int CountIndexesTests(SubscriptionType subscriptionType, InputSubReq sr)
        {
            ...
            return _subHelper.SubHandler.Count(subReq.BindingDescriptor.Type, subReq.BindingDescriptor.Index);
        }
